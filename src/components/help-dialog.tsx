            ...
            <div className="help-dialog">
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>{zh ? '在“设置 → 设备驱动”查看 WinUSB 状态；需要时按提示打开集成的 Zadig 安装器。' : 'Check WinUSB under Settings → Device driver; when needed, follow the integrated Zadig installer guidance.'}</li>
                    </ul>
                </section>

                <section>
                    <h3>{t('Local processing')}</h3>
                    <p>{t('Audio processing, metadata, transcoding, AI access and device communication stay on this computer.')}</p>
                </section>
            </div>
        </AppDialog>
    );
